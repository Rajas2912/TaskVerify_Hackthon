    ...
    <div className={styles.cardContainer}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.image}>
          ...
          <div className={styles.title}>Upload Assignments</div>
          <div className={styles.desc}>
            Upload Your Assignments Here And Know How Much You Have Scored.
          </div>
        </div>
